...
#include <math.h>
void init_data(double *data, const int dimx, const int dimy, const int dimz)
{
...
void reference_implementation(double *next, double *prev, double *coeff, 
		  double *vel,
